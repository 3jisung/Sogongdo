...
<body>
	...
	<form  action="workplaceInfoUpdate.do" method="post">
	<select name="name">
		<%   for(int i=0; i<list.size(); i++){   
				WorkPlaceDTO workplace = list.get(i); %>

			     <option value=<%=workplace.getName()%>><%=workplace.getName()%></option>
	...
	사업장 상태 : <input type="text" name="state" ><br>
	전화번호 : <input type="text" name="tel"><br>
	관리자 : <input type="text" name="admin_id"><br>
